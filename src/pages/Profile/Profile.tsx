...
export default function Profile() {
  ...
  const { data: DoctorData, isLoading } = useGetDoctorQuery(
  ...
  const services = [
    ...
    },
    {
      ...
      description:
        "Surgical procedures for skin diseases and aesthetic improvements.",
      icon: <Verified />,
    },
    {
      title: "Aesthetic Medicine",
      description:
        "Non-surgical cosmetic treatments to enhance skin appearance.",
      icon: <Verified />,
    },
    {
  ...
  const handelCheck = (checked: boolean) => {
    addSafe({
      id: DoctorData?.data?.isSafes[0]?.id,
      payload: { isSafe: checked, doctorId: DoctorData?.data?.id },
    });
  };
  ...
  const handelLimit = (limit: number) => {
    addSafe({
      id: DoctorData?.data?.isSafes[0]?.id,
      payload: { limit, doctorId: DoctorData?.data?.id },
    });
  };
          ...
          >
            <Stack spacing={2}>
              <Box>
                ...
                <Typography
                  variant="h4"
                  sx={{ fontWeight: 500, color: "#64748b", mb: 2 }}
                >
              ...
              <Box sx={{ display: "flex", flexDirection: "column", gap: 1 }}>
                ...
                <Typography
                  variant="body1"
                  sx={{ color: "#94a3b8", fontWeight: 600, fontSize: "1.1rem" }}
                >
          ...
          <Stack spacing={4}>
            ...
            >
              <CardContent sx={{ p: 4 }}>
                ...
                <Typography
                  variant="h6"
                  sx={{ mb: 3, color: "#334155", fontWeight: 700 }}
                >
                ...
                >
                  ...
                  >
                    Specialized training in <strong>Laser Surgery</strong> from
                    China and Fellow of the{" "}
                    <strong>Royal College of Physicians (Glasgow)</strong>.
                    Active Member of the{" "}
                    <strong>American College of Physicians</strong>, dedicated
                    to advancing dermatological science.
                  </Typography>
                </Box>
              </CardContent>
            </Card>
            ...
            <Typography
              variant="h4"
              sx={{ fontWeight: 800, color: "#0f172a", mt: 4, mb: 2, px: 2 }}
            >
              Services Offered
            </Typography>
            <Box
              ...
              <Box>
                ...
                >
                  ...
                  >
                    <Typography
                      variant="h6"
                      sx={{ fontWeight: 800, color: "#0f172a", mb: 2, px: 2 }}
                    >
                      Is Safe
                    </Typography>
                    <Switch
                      defaultChecked={DoctorData?.data?.isSafes[0]?.isSafe}
              ...
              <CardContent sx={{ p: 4 }}>
                ...
                <Stack spacing={4}>
                  <Box>
                    <Typography
                      variant="h5"
                      sx={{ color: "#1e293b", fontWeight: 800, mb: 1 }}
                    >
                    ...
                    <Box sx={{ display: "flex", gap: 1.5 }}>
                      <LocationOn
                        sx={{ color: "#94a3b8", fontSize: 20, mt: 0.5 }}
                      />
                      <Typography
                        variant="body1"
                  ...
                  >
                    ...
                    <Stack spacing={1}>
                      ...
                      >
                        ...
                        >
                          Closed on {doctorData.chamber.offDay}
                        </Typography>
                      </Box>
                    </Stack>
                  </Box>
                  ...
                  >
                    ...
                    <Typography
                      variant="h3"
                      sx={{ color: "#60a5fa", fontWeight: 800, mb: 3 }}
                    >
                    ...
                    <Button
                      ...
                      onClick={() =>
                        (window.location.href = `tel:${doctorData.chamber.serial.replace(/\s/g, "")}`)
                      }
                    >
                      Call for Serial
                    </Button>
